                    ...
                    <table class="admin-panel">
                        ...
                        <?php foreach ($allMeets as $meet) { ?>
                            <tr>
                                ...
                                <td><?= $meet->adresse ?></td>
                                <td><?= $meet->date ?></td>
                                <td><a href="meetdetails.php?meet=<?= $meet->idEvenement ?>" class="info-meet"><i class="fa-solid fa-circle-info"></i></a><a href="admin_update.php?id=<?= $meet->idEvenement ?>" class="mod-meet"><i class="fa-solid fa-pen"></i></a><a href="controler/delete.php?id=<?= $meet->idEvenement ?>" class="delete-meet"><i class="fa-solid fa-trash"></i></a></td>
                            </tr>
                        <?php } ?>
                    </table>
                </div>
